...
export default function CardGrade({ cardROI, benefits, compact }: CardGradeProps) {
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-4 rounded-lg border border-border bg-bg-card p-4 shadow-card transition-colors hover:bg-bg-elevated">
        <div
  ...
  return (
    <div className="rounded-xl border border-border bg-bg-card p-6 shadow-card">
      ...
      {daysUntilRenewal !== null && daysUntilRenewal <= 90 && (
        <div className="mt-3 flex items-center gap-2 text-sm" style={{ color: daysUntilRenewal <= 30 ? "#C4717A" : "#D4983B" }}>
          <span>\u26A0\uFE0F</span>
