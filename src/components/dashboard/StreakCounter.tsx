...
export default function StreakCounter({ benefits, usage }: StreakCounterProps) {
  ...
  if (streakCount === 0) {
    return (
      <div className="rounded-lg border border-border bg-bg-card px-5 py-4 shadow-card">
  ...
  return (
    <div className="flex items-center gap-4 rounded-lg border border-border bg-bg-card px-5 py-4 shadow-card">
      <span className="text-2xl">{fires}</span>
      <div>
        <span className="animate-streak-pulse inline-block font-mono-data text-2xl font-bold text-green">
          {streakCount}
        </span>
